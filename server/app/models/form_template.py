...
class FormTemplate(db.Model):
    ...
    # Fix relationship name to match AssignedForm table and attribute
    forms_as_practitioner = db.relationship('AssignedForm', back_populates='form_template', lazy='select')
